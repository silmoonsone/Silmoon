...
namespace Silmoon.Net.Extension
{
    public static class WebSocketExtension
    {
        ...
        public static Task<string> ReceiveTask(this WebSocket webSocket, CancellationToken? cancellationToken = null, int bufferSize = 5120)
        {
            if (!cancellationToken.HasValue) cancellationToken = CancellationToken.None;
        ...
        public static Task<string> ReceiveTask(this WebSocket webSocket, Encoding encoding, CancellationToken? cancellationToken = null, int bufferSize = 5120)
        {
            if (!cancellationToken.HasValue) cancellationToken = CancellationToken.None;
